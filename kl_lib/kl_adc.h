...
/* At full speed (16MHz) lowest SampleTime possible is ast192Cycles.
 * At div2 (8MHz) - ast96Cycles, at div4 - ast48Cycles.
 */
...
public:
    ...
    uint32_t GetResult(uint8_t AChannel);
    uint32_t Adc2mV(uint32_t AdcChValue, uint32_t VrefValue) { // See RefMan p288
